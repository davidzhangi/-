package com.david.blueconnection.bluetooth;
...
import com.david.blueconnection.callback.BleIndicateCallback;
import com.david.blueconnection.callback.BleMtuChangedCallback;
import com.david.blueconnection.callback.BleNotifyCallback;
import com.david.blueconnection.callback.BleReadCallback;
import com.david.blueconnection.callback.BleRssiCallback;
import com.david.blueconnection.callback.BleWriteCallback;
import com.david.blueconnection.data.BleConnectStateParameter;
import com.david.blueconnection.data.BleDevice;
import com.david.blueconnection.data.BleMsg;
import com.david.blueconnection.exception.ConnectException;
import com.david.blueconnection.exception.OtherException;
import com.david.blueconnection.exception.TimeoutException;
import com.david.blueconnection.utils.BleLog;
...
public class BleBluetooth {
    ...
    private BluetoothGattCallback coreGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            Log.e("david", "启动服务发现:" + gatt.discoverServices());

            BleLog.d("BluetoothGattCallback：onConnectionStateChange "
                    + '\n' + "status: " + status
                    + '\n' + "newState: " + newState
                    + '\n' + "currentThread: " + Thread.currentThread().getId());
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            ...
            Log.d("david", "数据返回的回调（此处接收BLE设备返回数据）");
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                Log.d("david", "写入成功" + characteristic.getValue());
            }
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                Log.e("david", "读取成功" + characteristic.getValue());
            }
