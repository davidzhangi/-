...
public class CharacteristicOperationFragment extends Fragment {
    ...
    public void showData() {
        ...
        if (childList.contains(child)) {
            ...
            Log.d("david", "uuid::" + characteristic.getUuid());
            ...
            if (value == null || value.length <= 0) {
                ...
                Log.d("david", "value::" + HexUtil.formatHexString(characteristic.getValue()));
            }
                ...
                case PROPERTY_WRITE: {
                    ...
                    btn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            Log.d("david", "???::" + characteristic.getService().getUuid().toString());
                            Log.d("david", "???::" + characteristic.getUuid().toString());
